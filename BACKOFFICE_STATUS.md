...
**Última atualização:** 10 de junho de 2026 (Expedição **E1+E2** — migration 0026 (`entregas`) **aplicada** e a **tela `/expedicao/:id`** no ar: gerador de snapshot por ciclo, status por toque na bancada, copiar rota por região e imprimir etiquetas; nav Expedição deixou de ser esmaecida. Antes: P1a+P1b — **ciclos** (migration 0025 + UI de ciclos)).
